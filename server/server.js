...
app.post('/api/entries', (req, res) => {
    ...
    const stmt = db.prepare(`INSERT INTO entries (title, author, genre, notes, rating, date, bookCover) VALUES (?, ?, ?, ?, ?, ?, ?)`);
    stmt.run(title, author, genre, notes, rating, currentDate, bookCover, function (err) {
      if (err) {
